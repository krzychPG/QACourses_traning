...
def test_customer_data_on_home_page(ap):
    customer_from_home_page = ap.customer.get_customer_list()[0]
    customer_from_edit_page = ap.customer.get_customer_info_from_edit_page(0)
...
def test_customer_data_on_customer_view_page(ap):
    customer_from_view_page = ap.customer.get_customer_from_view_page(0)
    customer_from_edit_page = ap.customer.get_customer_info_from_edit_page(0)
